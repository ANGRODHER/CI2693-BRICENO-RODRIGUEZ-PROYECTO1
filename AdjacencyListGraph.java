...
public class AdjacencyListGraph implements Graph<vertex> {
    ...
    public boolean connect(vertex from, vertex to){
        // Esta función establece la relación entre dos vértices si existe una conexión entre ellos.
    ...
    public List<vertex> getInwardEdges(vertex to){
        // Esta función devuelve una lista de vértices predecesores que tienen una conexión con el vértice dado.
    ...
    public List<vertex> getOutwardEdges(vertex from){
        // Esta función devuelve una lista de vértices sucesores que tienen una conexión con el vértice dado.
    ...
    public List<vertex> getVerticesConnectedTo(vertex vertex){
        // Esta función devuelve una lista de vértices que tienen una conexión con el vértice dado.
